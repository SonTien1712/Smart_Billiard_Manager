...
import com.BillardManagement.DTO.Response.*;
...
public class StaffBillingController {
    ...
    public ResponseEntity<DashboardEmployeeDTO> todayStats(
            @RequestParam(value = "clubId", required = false) Integer clubId
    ) {
        ...
        DashboardEmployeeDTO dto = new DashboardEmployeeDTO((int) count, revenue);
        return ResponseEntity.ok(dto);
    }
